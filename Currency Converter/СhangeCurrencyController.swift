...
//  Currency Converter
//
//  Created by Johnnie Walker on 18.10.2019.
...
class СhangeCurrencyController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, canEditRowAt indexPath: IndexPath) -> Bool {
        // Return false if you do not want the specified item to be editabl e.
        return true
    }
    */
